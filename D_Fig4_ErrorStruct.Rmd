...
Param_df%>%
  ...
  geom_segment(aes( x= q5, xend = q95, yend = Model , col =Model ), linewidth = 2)+
  geom_segment(aes( x= q20, xend = q80, yend = Model, col =Model  ), linewidth = 4)+
  geom_point(size =2)+
...
ggsave( 'Figures/SI2.png',SI2,  height= 6, width=6, dpi = 600, bg = 'white')
